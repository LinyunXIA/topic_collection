...
- macOS Apple Silicon，Python 3.14（`project/.venv`）—— **3.14 风险**：selectolax / asyncpg / lxml 这类带 C 扩展的依赖，PyPI 上 3.14 wheel 可能没齐；装不上别恋战，**直接退 3.12 或 3.13**，解释器版本不是这个项目的价值所在
